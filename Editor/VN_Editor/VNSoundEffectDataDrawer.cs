...
namespace Genoverrei.Library.Editor
{
    ...
    public class VNSoundEffectDataDrawer : PropertyDrawer
    {
        ...
        private readonly Color _themeColor = new(0.75f, 0.6f, 0.9f); // ม่วงพาสเทลนุ่มนวล
        ...
        public override void OnGUI(Rect pos, SerializedProperty prop, GUIContent label)
        {
            ...
            prop.isExpanded = EditorGUI.Foldout(foldoutRect, prop.isExpanded, $"Sound Effect {index}", true, headerStyle);

            if (GUI.Button(clearBtnRect, "Clear", EditorStyles.miniButton))
            {
                prop.FindPropertyRelative("SoundEffectClip").objectReferenceValue = null;
            ...
            if (prop.isExpanded)
            {
                ...
                DrawRequiredProperty(ref y, pos, prop.FindPropertyRelative("SoundEffectClip"));
        ...
        public override float GetPropertyHeight(SerializedProperty prop, GUIContent label)
        {
            ...
            if (prop.isExpanded)
            {
                ...
                h += GetRequiredPropertyHeight(prop.FindPropertyRelative("SoundEffectClip"));
            }
            return h;
        }
        ...
        private void CheckAndClearIfNewlyAdded(SerializedProperty property)
        {
            ...
            if (arrayProp != null && arrayProp.isArray)
            {
                ...
                if (_arraySizes.TryGetValue(arrayPath, out int prevSize))
                {
                    ...
                    {
                        property.FindPropertyRelative("SoundEffectClip").objectReferenceValue = null;
